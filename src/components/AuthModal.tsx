...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-[oklch(0.10_0_0/0.9)] border border-white/8 backdrop-blur-[40px] max-w-lg p-10">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <Input
            ...
            className="px-6 py-4 h-14 rounded-full text-lg bg-white/8 border-white/15 focus:border-accent focus:ring-accent"
            required
          />
          ...
          <Button
            ...
            className="btn-gradient w-full text-xl h-14"
          >
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center">
            <span className="bg-[oklch(0.06_0_0)] px-3 text-sm text-gray-500">
              or connect with
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-5">
          <Button
            ...
            disabled={isSubmitting}
            variant="outline"
            className="px-6 py-4 h-auto flex items-center justify-center bg-white/5 border-white/15 hover:bg-accent/20 hover:border-accent"
          >
          ...
          <Button
            ...
            disabled
            variant="outline"
            className="px-6 py-4 h-auto flex items-center justify-center bg-white/5 border-white/15 opacity-50 cursor-not-allowed"
